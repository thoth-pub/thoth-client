...
bash -c "python3 -m thothlibrary.cli work --version=0.4.2 --workId=e0f748b2-984f-45cc-8b9e-13989c31dda4 --raw > thothlibrary/thoth-0_4_2/tests/fixtures/work.json"
...
bash -c "python3 -m thothlibrary.cli work --version=0.4.2 --workId=e0f748b2-984f-45cc-8b9e-13989c31dda4 --serialize > thothlibrary/thoth-0_4_2/tests/fixtures/work.pickle"
