...
class Thoth042Tests(unittest.TestCase):
    ...
    def test_funders(self):
        ...
        """
        with requests_mock.Mocker() as m:
            mock_response, thoth_client = self._setup_mocker('funders', m)
            self._pickle_tester('funders', thoth_client.funders)
        return None
    ...
    def test_funders_bad_input(self):
        ...
        """
        with requests_mock.Mocker() as m:
            mock_response, thoth_client = self._setup_mocker('funders_bad', m)
            self._pickle_tester('funders', thoth_client.funders,
                                negative=True)
    ...
    def test_funders_raw(self):
        ...
        with requests_mock.Mocker() as m:
            mock_response, thoth_client = self._setup_mocker('funders', m)
            self._raw_tester(mock_response, thoth_client.funders)
        return None
